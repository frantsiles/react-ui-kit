...
module.exports = {
  content: [
    ...
    join(__dirname, 'apps/**/{src,pages,components,app}/**/*!(*.stories|*.spec).{ts,tsx,html}'),
    join(__dirname, 'packages/**/{src,components}/**/*!(*.stories|*.spec).{ts,tsx,html}'),
  ...
  plugins: [
    ...
    function({ addComponents }) {
      addComponents({
        ...
        '.btn-outline': {
          '@apply border border-primary-500 text-primary-500 hover:bg-primary-50 focus:ring-2 focus:ring-primary-500 focus:ring-offset-2': {},
        },
        '.btn-ghost': {
          '@apply text-primary-500 hover:bg-primary-50 focus:ring-2 focus:ring-primary-500 focus:ring-offset-2': {},
        },
      });
    },
  ],
