...
// ../../node_modules/.pnpm/@storybook+addon-a11y@9.1.1_8654575c9e4d5af64fde72b998175ed7/node_modules/@storybook/addon-a11y/dist/preview.mjs
...
var run = async (input = DEFAULT_PARAMETERS, storyId) => {
  var _a;
  let axe = ((_a = await import("./axe-IMNCD2YA.js")) == null ? void 0 : _a.default) || globalThis.axe, { config = {}, options = {} } = input;
    ...
    if (result) {
      ...
      if (reporting.addReport({ type: "a11y", version: 1, result, status: hasViolations ? getMode() : "passed" }), getIsVitestStandaloneRun() && hasViolations && getMode() === "failed") {
        if (!vitestMatchersExtended) {
          let { toHaveNoViolations } = await import("./matchers-7Z3WT2CE-5HZUKEWU.js");
