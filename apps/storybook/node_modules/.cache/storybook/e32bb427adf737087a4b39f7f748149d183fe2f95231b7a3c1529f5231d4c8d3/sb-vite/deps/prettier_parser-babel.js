...
// ../../node_modules/.pnpm/prettier@3.7.4/node_modules/prettier/plugins/babel.js
var require_babel = __commonJS({
  "../../node_modules/.pnpm/prettier@3.7.4/node_modules/prettier/plugins/babel.js"(exports, module) {
    (function(f) {
      function e() {
        var i = f();
        return i.default || i;
...
`);
      ...
      var Ki = /* @__PURE__ */ new Set([103, 109, 115, 105, 121, 117, 100, 118]), st = class {
        ...
        tokens = [];
        constructor(t, e) {
          super(), this.state = new et(), this.state.init(t), this.input = e, this.length = e.length, this.comments = [], this.isLookahead = false;
        }
        pushToken(t) {
